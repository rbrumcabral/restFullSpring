...
class UserServiceTests {
	...
	void testFindByIdOK() {
		...
		assertEquals(1L, response.getInvestments().getFirst().getId());
		...
		assertEquals(1L, response.getSavedExpenses().getFirst().getId());
	...
	void testFindAll() {
		...
		assertEquals(1L, response.get(0).getInvestments().getFirst().getId());
		...
		assertEquals(1L, response.get(0).getSavedExpenses().getFirst().getId());
		...
		assertEquals(1L, response.get(1).getInvestments().getFirst().getId());
		...
		assertEquals(1L, response.get(1).getSavedExpenses().getFirst().getId());
